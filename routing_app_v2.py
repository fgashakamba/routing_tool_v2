    ...
    ui.layout_columns(
        ui.row(
            ui.column(3,  
                ...
                ui.card(
                    ui.card_header("Actions & Downloads"),
                    ui.p(
                        ...
                        ui.input_action_button("Show_Segments_Table", label="Show route segments", class_="btn-sm btn-info w-100 mb-2"),
                        ui.input_action_button("Show_Table", label="Show surface statistics", class_="btn-sm btn-info w-100 mb-2"),
                    )
                )
            ),
            ui.column(9, 
...
def server(input, output, session):
    ...
    selected_source = reactive.Value(None)
    selected_final_stop = reactive.Value(None)
